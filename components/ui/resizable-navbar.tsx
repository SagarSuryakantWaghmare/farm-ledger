...
export const NavbarLogo = () => {
  return (
    <div className="relative z-20 flex items-center space-x-2 px-2 py-1">
      <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-600 text-white shadow-lg shadow-emerald-200 dark:shadow-none">
        <svg
        ...
        >
          ...
          <path d="M12 20V4" />
          <path d="M12 7c-2.5 0-5 2-5 4.5S9.5 16 12 16" />
          <path d="M12 7c2.5 0 5 2 5 4.5S14.5 16 12 16" />
        </svg>
      </div>
